<template>
    <main>
        ...
        <div class="container">
            ...
            <div class="row">
                <h1 class="my-3">Elenco dei post</h1><a href="http://127.0.0.1:8000/login" class="ml-auto my btn btn-white">Login</a>
            </div>
                ...
                <div class="col-4 card-group my-3" v-for="post in posts" :key="post.id">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="http://127.0.0.1:8000/admin/posts" class="btn btn-primary">Vai al post</a>
                        </div>
                    </div>
