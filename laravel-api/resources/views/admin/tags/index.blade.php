    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <a href="{{route('admin.tags.create')}}" class="btn btn-primary my-3">Crea un tag</a>
                        ...
                        @foreach ($tags as $tag)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <button type="button" class="btn btn-danger mJS_deleteButton"  value="{{$tag}}" data-toggle="modal" data-target="#staticBackdrop">
                                        Elimina
                                    </button>
                                </td>
                            </tr>                            
